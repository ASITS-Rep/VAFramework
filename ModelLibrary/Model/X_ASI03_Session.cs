...
static long serialVersionUID = 27907702599246L;/** Last Updated Timestamp 2021-07-06 4:14:42 PM */
public static long updatedMS = 1625577282457L;/** AD_Table_ID=1000777 */
...
@return Type */
public String GetASI03_Type() {return (String)Get_Value("ASI03_Type");}/** Set isPatEnter.
@param ASI03_isPatEnter isPatEnter */
public void SetASI03_isPatEnter (Boolean ASI03_isPatEnter){Set_Value ("ASI03_isPatEnter", ASI03_isPatEnter);}/** Get isPatEnter.
@return isPatEnter */
public Boolean IsASI03_isPatEnter() {Object oo = Get_Value("ASI03_isPatEnter");if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo);}return false;}/** Set Export.
